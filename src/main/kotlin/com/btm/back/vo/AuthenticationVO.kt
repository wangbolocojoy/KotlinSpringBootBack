...
//    var endDate:String? =null //证件有效期（国徽面）
    ...
    override fun toString(): String {
        return "AuthenticationVO(id=$id, userId=$userId, Name=$Name, Nation=$Nation, Birth=$Birth, IdNum=$IdNum, Authority=$Authority, FrontIdCard=$FrontIdCard, NationalIdCard=$NationalIdCard, authentication=$authentication)"
    }
